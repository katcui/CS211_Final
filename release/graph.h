...
private:
  ...
  // map stores the index positions of the vector^
  map<string, int> vertIndex;

  // vector of edges stored into map for quick lookup
  vector<map<int, double>> edges; // double is the weight
  ...
  int findVertex(string vertex) const;
